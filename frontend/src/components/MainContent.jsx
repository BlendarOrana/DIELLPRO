...
const DiellPortfolio = () => {
    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-16 px-4 sm:px-6 overflow-hidden w-full">
    ...
    {/* Logo Container - Added w-full & flex justify-center to guarantee center bounds */}
    <div 
        className="mb-6 md:mb-8 flex justify-center items-center w-full"
        style={{ 
    ...
    {/* Text Wrapper - Enforced w-full and flex items-center */}
    <div className="text-center w-full z-10 max-w-4xl mx-auto space-y-6 md:space-y-8 mt-2 px-2 sm:px-4 flex flex-col items-center">
        ...
        >
            {/* Added ml-3 to offset the hidden mr-3 generated by WaveText, perfectly centering the letters */}
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold tracking-tighter text-yellow-400 mb-3 md:mb-4 leading-tight flex justify-center items-center ml-3 w-full">
                {pageLoaded && <WaveText text="Diell" delay={0.4} />}
            </h1>
            
            {/* Changed to flex-col on mobile so '//' sits on top, maintaining absolute perfect centering of the words */}
            <div className="text-lg sm:text-xl md:text-4xl text-white font-bold tracking-tight flex flex-col sm:flex-row items-center justify-center w-full text-center mt-2 md:mt-0">
                <span className="text-yellow-500 mb-1 sm:mb-0 sm:mr-3 md:mr-4 opacity-80">//</span> 
                <span>Building The Exceptional.</span>
            </div>
        </div>
        ...
        <p 
            ...
            className="text-sm sm:text-base md:text-xl text-neutral-400 max-w-3xl mx-auto font-light tracking-tight leading-relaxed px-4 pt-2 md:pt-4 text-center"
        >
        ...
        <div 
            ...
            className="pt-6 w-full max-w-[100vw] overflow-hidden flex justify-center"
        >
            <InfiniteTechMarquee />
        </div>
    </div>
    ...
    <div className="absolute bottom-6 md:bottom-12 left-1/2 transform -translate-x-1/2 z-10 flex justify-center">
